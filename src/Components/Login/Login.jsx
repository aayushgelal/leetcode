...
const Login = () => {
  ...
  return (
    ...
    <div className=" h-[calc(100vh-100px)] flex items-center justify-center ">
      <form className="rounded-lg shadow-md border-none p-20 bg-gray-50 min-w-fit w-5/12 " method="post" action="/signup">
        <div className=" text-2xl flex items-center justify-center font-semibold mb-10 ">Login</div>
